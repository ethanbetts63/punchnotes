...
from pipeline.import_utils.records import _bit_ratios, merge_attributes, upsert_comedian, upsert_episode, upsert_set
...
class RatioCalculationTests(TestCase):
    ...
    def test_set_ratio_stores_tag_density(self):
        from pipeline.import_utils.records import refresh_set_ratios
